...
const ROUTES: { match: (path: string) => boolean; meta: RouteMeta }[] = [
  ...
  },
  {
    ...
    meta: {
      title: `Explore — ${SITE}`,
      description:
        "Browse every scripture and tradition on NoorJyoti, from the Bible and Quran to the Bhagavad Gita and Guru Granth Sahib.",
    },
  },
  {
    match: (p) => p.startsWith("/tradition/"),
    meta: {
  ...
  {
    match: (p) => p.startsWith("/scripture/"),
    meta: {
